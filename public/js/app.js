...
socket.on('world:listings',x=>{listings=x||[];renderSlots();if(user){$('#myCarsCount').textContent=myActiveCars().length;if(!$('#myCarsModal').classList.contains('hidden'))renderMyCars()}});
